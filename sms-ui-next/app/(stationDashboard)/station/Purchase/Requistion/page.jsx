                      ...
                      <TooltipProvider>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Link href={`/station/Purchase/Requistion/viewacceptquatation/${item.mrid}`}>
                                <Button
                                  color="warning"
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            <TooltipTrigger asChild>
                               <Button 
                            className="p-0 dark:text-white text-black text-sm px-1 bg-transparent hover:bg-transparent"
                            onClick={() => handleOpenMailBox(item.email)} // Assuming email is a property of the item
                          >
                            <Mail size={20}></Mail>
                          </Button>
                            </TooltipTrigger>
                    ...
                    <div className="flex mb-2">
                      <TooltipProvider>
                        ...
                        <Link href={`/station/Purchase/Requistion/seequotation/${item.mrid}`}>
                                <Button className="p-0 dark:text-white ml-0 text-sm px-2 bg-transparent hover:bg-transparent text-black rounded-full">
