  ...
  return (
    <div className="p-4 bg-white rounded-md">
      <div className="flex justify-between items-center mb-6">
        <div className="text-orange-500 text-xl font-semibold">RETURN STOCK</div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        <div>
          ...
          <span>{deliveryData.odtitemsmappings.reduce((total, item) => total + item.itemqty, 0)}</span>
        </div>
        {/* <div>
        ...
        <table className="w-full border-collapse border border-gray-300">
          ...
          <tbody>
            {deliveryData.odtitemsmappings.map((item) => (
              item.orderReturns && item.orderReturns.map((orderReturn, i) => (
                <tr key={`${item.odtimid}-return-${i}`}>
                  <td className="p-2 border">{orderReturn.returnId}</td> {/* Display ReturnId */}
                  ...
                  <td className="p-2 border text-center">{orderReturn.returnquantity}</td>
              ...
              <tr key={item.odtimid}>
                ...
                <td className="p-2 border text-center">
                  <input
                    ...
                    onChange={(e) => handleQuantityChange(item.odtimid, e.target.value.replace(/\D/g, ""))}
