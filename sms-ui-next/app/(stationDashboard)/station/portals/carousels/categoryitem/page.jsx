...
const CategoryProductListModal = ({ onSelectProducts, cid, onClose }) => {
    console.log(cid, "cid")
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await CallFor2(
                `api/OCarouselVendorShopAdminAPI/CategoryAddPopupList`,
                "POST",
                {
                    ...bodyData,
    ...
    const handleConfirmSelection = async () => {
        try {
            const response = await CallFor2(
                'api/OCarouselVendorShopAdminAPI/CategoryAddPopup',
                'POST',
                {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => {
            ...
            <DialogTrigger asChild>
                <Button variant="outline">Open Category Product List</Button>
            </DialogTrigger>
            <DialogContent className="max-w-[95vw] w-full max-h-[95vh] flex flex-col">
                <DialogHeader className="flex-shrink-0">
                    <DialogTitle>Category Product List</DialogTitle>
                    <DialogDescription>Search and select category products</DialogDescription>
                </DialogHeader>
...
export default CategoryProductListModal;    