      ...
      <table className="min-w-full text-left">
        ...
        <thead>
          <tr>
            ...
            <th className="px-2 py-2 cursor-pointer text-center">STATUS</th>
                    ...
                    <TooltipProvider>
                          <Tooltip>
                            <TooltipTrigger asChild>
                             <Link
                      href={`/station/Catalogue/Requests/viewrequest/${item.proid}`}
                    >
                      <Button className="p-0 mr-2 bg-transparent hover:bg-transparent text-black  dark:text-white">
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            <TooltipTrigger asChild>
                             <Link
                      href={`/station/Catalogue/Requests/editrequest/${item.proid}`}
                    >
                      <Button className="p-0 mr-2 bg-transparent hover:bg-transparent text-black  dark:text-white">
