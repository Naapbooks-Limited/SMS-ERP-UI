...
const attributeSchema = Yup.object().shape({
  ...
  attributeValues: Yup.array()
    .of(
      Yup.object().shape({
        avname: Yup.string().required("Value name is required"),
      })
    )
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await attributeSchema.validate(
        { attributeName, description, attributeValues },
        { abortEarly: false }
      );
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            {errors.attributeName && (
              <p className="text-red-500 text-sm">{errors.attributeName}</p>
            )}
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md space-y-4">
        ...
        {errors.attributeValues && (
          <p className="text-red-500 text-sm">{errors.attributeValues}</p>
        )}
