  ...
  return (
    <div className="container mx-auto">
      ...
      <div className=" justify-between flex gap-1 pb-3 ">
        ...
        <div>
          {/* <Link href={"/warehouse/Catalogue/Categories/categoriadd"}>
      ...
      <table className="min-w-full text-left">
        ...
        <thead>
          <tr>
            ...
            >
              Parent catagory{" "}
              {sortConfig.key === "parentCategoryName"
                ? sortConfig.direction === "asc"
                  ? "▲"
                  : "▼"
                : ""}
        ...
        <tbody>
          {filteredData.map((item) => (
            <tr key={item.catid}>
              ...
              <td className="px-4 py-2">{item.parentCategoryName || 0}</td>
              <td className="px-4 py-2">
                <div>
                  <Link
                    href={`/warehouse/Catalogue/Categories/categoriview/${item.catid}`}
                  >
                  ...
                  {/* <Link
                    href={`/warehouse/Catalogue/Categories/categoriedit/${item.catid}`}
                  >
                    <Button className="p-0 mr-2 bg-transparent hover:bg-transparent text-black  dark:text-white  ">
