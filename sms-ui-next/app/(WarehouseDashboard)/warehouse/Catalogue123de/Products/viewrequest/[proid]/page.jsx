...
function ViewRequest({ params }) {
  ...
  /> : "N/A"}
      ...
      <div className="flex justify-end">
        <div>
          <Button className="text-white bg-blue-950 mr-3 " onClick={() => router.push(`/warehouse/Catalogue/Requests/editrequest/${params.proid}`)}>
              Edit Request
            </Button>
        ...
        <tbody>
          {pvid && pvid.map((item) => (
            <tr key={item.id}>
              ...
              <td className="px-2 py-2">
                <div>
                  <Link href={`/warehouse/Catalogue/Products/viewproductvariant/${item.pvid}`}>
                    <Button className="p-0 mr-2 bg-transparent hover:bg-transparent text-black  dark:text-white">
                      <Eye size={20}></Eye>
                    </Button>
                  </Link>
                  <Link href={`/warehouse/Catalogue/Products/editproduct/${item.pvid}`}>
                    <Button className="p-0 mr-2 bg-transparent hover:bg-transparent text-black  dark:text-white">
