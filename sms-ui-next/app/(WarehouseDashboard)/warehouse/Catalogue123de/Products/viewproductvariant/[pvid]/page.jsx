...
import { Edit, ArrowLeft, Eye, Package, DollarSign, Archive, Tag, Truck, ImageIcon } from "lucide-react";
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="mb-6 flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          {/* <Button
            onClick={() => router.push(`/station/Catalogue/Products/edit/${params.pvid}`)}
      ...
      {/* Attributes */}
      {productData.pvamappings && productData.pvamappings.length > 0 && (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-6">
          <div className="flex items-center mb-4">
          ...
          <div className="space-y-4">
            {productData.pvamappings.map((mapping, index) => (
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <span className="font-semibold text-gray-900 dark:text-white">
                    {mapping.pvamvalues && mapping.pvamvalues.length > 0 
                      ? getAttributeValueName(mapping.attributeid, mapping.pvamvalues[0].avid)
                      : 'No value set'
                    }
                  </span>
                </div>
            ...
            {productData.relatedproducts.map((product, index) => (
              <div key={index} className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <p className="font-medium text-gray-900 dark:text-white">
                  {getSkuName(product.relatedproid)}
                </p>
              </div>
            ))}
          </div>
      ...
      <div className="flex justify-center space-x-4 mt-8">
        <Button
          onClick={() => router.push(`/warehouse/Catalogue/Products/editproduct/${params.pvid}`)}
