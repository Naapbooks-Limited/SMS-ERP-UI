...
const Staff = () => {
  ...
  const isAdmin = userData.roletypeid === 2;
  ...
  const staffSampleContent = `Full Name,Email,Phone,Role
John Doe,john@example.com,1234567890,Manager
Jane Smith,jane@example.com,0987654321,Employee`;




  const handleStaffImport = async (file) => {
    if (!ImportUrl) {
      console.error("Import URL is not set");
      return;
    }
...
/>
          ...
          <Button
            color="warning"
            className="shadow-md"
            onClick={() => router.push("/warehouse/warehouses/staff/addemployee")}
          >
                  ...
                  <td className="px-4 py-2">
                    <div>
                      <Button
                        ...
                        onClick={() =>
                          router.push(
                            `/warehouse/warehouses/staff/staffDetail/${item.uid}`
                          )
                        }
                      >
                        <Eye size={20}></Eye>
                      ...
                      {isAdmin && (
                        <Button
                          ...
                          onClick={() =>
                            router.push(
                              `/warehouse/warehouses/staff/editEmployee/${item.uid}`
                            )
                          }
                        >
