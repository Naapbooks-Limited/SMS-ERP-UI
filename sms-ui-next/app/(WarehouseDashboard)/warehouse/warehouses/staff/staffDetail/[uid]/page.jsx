  ...
  return (
    <>
      ...
      <div className=" grid grid-cols-2 ml-16">
        <div className="flex items-center mb-4">
          ...
          <p className="text-blue-900 dark:text-white ml-4">
            ...
            <span className="ml-5">{data.firstname}</span>{" "}
          </p>
        </div>
        <div className="flex items-center mb-4">
          <label className="w-1/6 font-bold mr-2 text-blue-900 dark:text-white">
          ...
          <p className="text-blue-900 dark:text-white ml-4">
            {" "}
            <span className="font-bold"> : </span>{" "}
            <span className="ml-5">{data.lastname}</span>{" "}
          </p>
        </div>
        ...
        <div className="flex items-center mb-4">
          ...
          <p className="text-blue-900 dark:text-white ml-4">
            {" "}
            <span className="font-bold"> : </span>{" "}
            <span className="ml-5">{data.emailid}</span>{" "}
          </p>
        </div>
        ...
        <div className="flex items-center mb-4">
          ...
          <p className="text-blue-900 dark:text-white ml-4">
            {" "}
            <span className="font-bold"> : </span>{" "}
            <span className="ml-5">{data.mobno}</span>{" "}
          </p>
        </div>
        ...
        <div className="flex items-center mb-4">
          ...
          <p className="text-blue-900 dark:text-white ml-4">
            {" "}
            <span className="font-bold"> : </span>{" "}
            <span className="ml-5">{data.employeeId}</span>{" "}
          </p>
        </div>
        ...
        <div className="flex items-center mb-4">
          ...
          <p className="text-blue-900 dark:text-white ml-4">
            {" "}
            <span className="font-bold"> : </span>{" "}
            <span className="ml-5">{data.rolename}</span>{" "}
          </p>
        </div>
        ...
        <div className="flex items-center mb-4">
          ...
          <p className="text-blue-900 dark:text-white ml-4">
            {" "}
            <span className="font-bold"> : </span>{" "}
            <span className="ml-5">{data.password}</span>{" "}
          </p>
        </div>
        <div className="flex items-center mb-4">
          <label className="w-1/6 font-bold mr-2 text-blue-900 dark:text-white">
          ...
          <p className="text-blue-900 dark:text-white ml-4">
            <span className="font-bold"> : </span>{" "}
            <span className="ml-5">
              {data.accountstatus == 48
                ? "Yes"
                : data.accountstatus == 49
                ? "No"
                : ""}
            </span>
          </p>
      ...
      <div>
        ...
        <div className="ml-16">
          {role && (role.data.roletypeid === 1 || role.data.roletypeid === 2 || role.data.roletypeid === 5) ? (
            <div className="text-green-600 font-bold text-lg">
              This is admin and has all rights.
            </div>
          ) : (
            <table>
              <tbody>
