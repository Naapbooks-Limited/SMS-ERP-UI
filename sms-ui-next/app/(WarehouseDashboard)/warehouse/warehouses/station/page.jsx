      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <div>
          <Button
            ...
            className="shadow-md"
            onClick={() =>
              router.push("/warehouse/warehouses/station/addstation")
            }
          >
                ...
                <td className="px-4 py-2">
                  <div>
                    <Button
                      ...
                      onClick={() =>
                        router.push(
                          `/warehouse/warehouses/station/viewstation/${item.uoid}`
                        )
                      }
                    >
                      <Eye size={20} />
                    ...
                    <Button
                      ...
                      onClick={() =>
                        router.push(
                          `/warehouse/warehouses/station/editStation/${item.uoid}`
                        )
                      }
                    >
                      <FilePenLine size={20} />
