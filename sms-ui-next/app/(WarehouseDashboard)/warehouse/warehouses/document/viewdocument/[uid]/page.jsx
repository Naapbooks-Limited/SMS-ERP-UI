   ...
   { data.docurl && data.docurl } */}
      <div className="container mx-auto">
        <div className="flex justify-between">
          ...
          <Button
            color="warning"
            onClick={() => router.push("/warehouse/warehouses/document")}
          >
            <Undo2 size={20} />
            Back
          </Button>
        ...
        <form className="space-y-4 mt-7">
          <div className="grid grid-cols-2 w-75">
            ...
            <div className="flex items-center mb-5">
              <label className="w-1/6 font-bold mr-2 text-blue-900 dark:text-white">DocDisc</label>
              <p className='text-blue-900 dark:text-white ml-4'> <span className='font-bold'> : </span><span className="ml-3">{data.docDesc}</span> </p>
            </div>
            <div className="flex items-center mb-5">
            ...
            <div className="flex items-center space-x-4">
              ...
              <p className='flex text-blue-900 dark:text-white ml-4'> <span className='font-bold pr-2'> :  </span> 
              <a className="ml-3"  href={GlobalPropperties.viewdocument + `${data.docUrl}`}><Eye size={20} />  </a> </p>
            </div>
