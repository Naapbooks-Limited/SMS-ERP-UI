  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="text-2xl text-orange-400">Catalog Document List</div>
        <Button
          color="warning"
          className="shadow-md"
          onClick={() => router.push("/warehouse/Catalogue/Document/adddocument")}
        >
  ...
  <tbody>
    {sortedData.map((item) => (
      <tr key={item.id}>
        ...
        <td className="px-4 py-2">{item.entityName}</td>
        <td className="px-4 py-2">{item.uploadDate?.split("T")[0]}</td>
                  ...
                  <TooltipProvider>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Link
                      href={`/warehouse/Catalogue/Document/viewdocument/${item.docId}`}
                    >
                      <Button className="p-0  bg-transparent hover:bg-transparent text-black dark:text-white">
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            <TooltipTrigger asChild>
                          <Link
                    href={`/warehouse/Catalogue/Document/editdocument/${item.docId}`}
                  >
                    <button>
                      <FilePenLine size={18} />
                    </button>
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            <TooltipTrigger asChild>
                           <button
                    onClick={() => handleDeleteUser(item.docId)}
                  >
                    <Trash size={18} />
                  </button>
                            </TooltipTrigger>
