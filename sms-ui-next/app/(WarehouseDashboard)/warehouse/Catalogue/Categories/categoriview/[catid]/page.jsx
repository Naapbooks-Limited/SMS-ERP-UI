...
<form className="max-w-7xl mx-auto p-6 bg-white dark:bg-black   rounded-md shadow-md">
    ...
    <Link href={"/warehouse/Catalogue/Categories"}>    <Button color="warning" className="shadow-md">
      ...
      <div className="grid grid-cols-1 gap-4  ">
        ...
        <div className="flex items-center space-x-4">
            ...
            <label htmlFor="sku" className="w-1/4 font-medium dark:text-white text-gray-700">Parent Category : {formData.parentCategoryName} </label>
      ...
      {/* <Link href={"/warehouse/Catalogue/Categories"}>  <button type="submit" className="mt-6 me-3  px-3 py-2 bg-[#11357C] text-white rounded-md focus:outline-none ">Cancel</button> </Link>
