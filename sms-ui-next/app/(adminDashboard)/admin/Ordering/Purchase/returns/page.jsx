      ...
      <table className="min-w-full text-left">
        <thead>
          <tr>
            ...
            <th
              className="px-2 py-2 cursor-pointer"
              onClick={() => handleSort("odtitemsmapping.odtid")}
            >
              PO No{" "}
              {sortColumn === "odtitemsmapping.odtid" &&
                (sortDirection === "asc" ? "▲" : "▼")}
            </th>
            <th
              className="px-2 py-2 cursor-pointer"
            ...
            <th
              className="px-2 py-2 cursor-pointer"
              onClick={() => handleSort("odtitemsmapping.deliveredqty")}
            >
              TOTAL QUANTITY{" "}
              {sortColumn === "odtitemsmapping.deliveredqty" &&
                (sortDirection === "asc" ? "▲" : "▼")}
            </th>
            <th
              className="px-2 py-2 cursor-pointer"
            ...
            sortedData.map((item, index) => (
              <tr key={item.id}>
                ...
                <td className="px-2 py-2">
                  {item.odtitemsmapping.deliveredqty}
                </td>
                <td className="px-2 py-2">{item.returnquantity}</td>
                <td className="px-2 py-2">
                  <Link href={`/admin/Ordering/Purchase/returns/viewreturns/${item.returnId}`}>
                  <Button
                    color="warning"
