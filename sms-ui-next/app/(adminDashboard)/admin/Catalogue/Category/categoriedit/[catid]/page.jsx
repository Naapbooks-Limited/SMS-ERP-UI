...
function Categoriedit({ params }) {
  ...
  useEffect(() => {
    if (options.length > 0 && formData.parentcatid) {
      const parentCategoryOption = options.find(
        (option) => option.value === formData.parentcatid
      );
  ...
  return (
    <div>
      <form
        className="max-w-7xl mx-auto p-6 bg-white dark:bg-black rounded-md shadow-md"
      ...
      >
          ...
          <div>
            <div className="flex items-center space-x-4">
              ...
              <input
                ...
                className={`flex-grow p-3 border  focus:outline-none focus:ring-2 focus:ring-blue-500 ${
        ...
        <div className="flex justify-center">
          <Link href="/admin/Catalogue/Category">
            <button className="mt-6 me-3 px-3 py-2 bg-[#11357C] text-white rounded-md focus:outline-none">
              Cancel
            </button>
          </Link>
          <button
