      ...
      {data.length > 0 ? (
        <table className="min-w-full text-left">
          <thead>
            ...
            <th className="px-2 py-2 cursor-pointer">Station</th>
              ...
              <tr key={item.pvid}>
                ...
                <td className="px-2 py-2">
                  <div className="w-24 h-24 bg-white overflow-hidden rounded-md shadow-md">
                    <img
                      src={`${GlobalPropperties.viewdocument}${item.productImageUrl[0]}`}
                      alt="Product"
                ...
                <td className="px-2 py-2 w-1/2">{item.pvname}</td>
                <td className="px-2 py-2">{item.pvsalesprice}</td>
                <td className="px-2 py-2">{item.orgName?.join(", ")}</td>
                      ...
                      <TooltipProvider>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Link
                      href={`/admin/Catalogue/product/viewproductvariant/${item.pvid}`}
                    >
                      <Button className="p-0 mr-2 bg-transparent hover:bg-transparent text-black  dark:text-white">
                        <Eye size={20}></Eye>
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                             <Link
                    href={`/admin/Catalogue/product/editproduct/${item.proid}`}
                  >
                    <Button className="p-0 mr-2 bg-transparent hover:bg-transparent text-black  dark:text-white">
