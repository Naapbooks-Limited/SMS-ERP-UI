  ...
  const fetchData = async () => {
    try {
      ...
      const response = await CallFor(
        `v2/Common/GetErrorLogsById?id=${params.eid}`,
        "get",
        null,
        "Auth"
      );
...
<div>
  <form className="max-w-7xl mx-auto p-6 bg-white dark:bg-black rounded-md shadow-md">
    ...
    <div
      className="flex justify-between items-center font-semibold bg-white dark:bg-black mt-5 p-3"
      style={{ boxShadow: "5px 5px 5px gray" }}
    >
      <div className="pt-1 text-lg">Products</div>
