...
const ProfileInfoComponent = () => {
  ...
  const avatarFallback = user?.username ? user.username[0].toUpperCase() : 'S';
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56 p-0" align="end">
        <DropdownMenuLabel className="flex gap-2 items-center mb-1 p-3">
          ...
          <div className="flex item-center ">
            ...
            <Link
              ...
              className="text-xs text-default-600 pt-1 hover:text-primary"
            >
              {user.username || 'ABC'}
            </Link>
        ...
        <DropdownMenuGroup>
          {[
            { name: "Profile", icon: "heroicons:user", href: "/station/Profile" },
